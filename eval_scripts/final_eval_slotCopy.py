...
def process_slotCopy_pred(slots_categorical):
	...
	with open("slotCopy_pred_0p99sampleDev_testGround_onTest.json","w") as dump_f:
...
total_eval = list(pkl.load(open('../detailed_results/2019-10-11_20_56_19_total_eval_results.pkl', 'rb')))
